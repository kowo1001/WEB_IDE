            ...
            <div className = "header__bottom">
                <div className = "row">
                    <ul className = "header__bottom-nav ul-nolist-inline">
                        <li><NavLink activeClassName = "nav-selected" to="/student/class">학습 관리</NavLink></li>
                        <li><NavLink activeClassName = "nav-selected" to="/student/listproblem">문제 리스트</NavLink></li>
                        <li><NavLink activeClassName = "nav-selected" to="/student/project">프로젝트 관리</NavLink></li>
                        <li><NavLink activeClassName = "nav-selected" to="/student">마이페이지</NavLink></li>
                    </ul>
                </div>
            </div>
      </div>
...
{/* <li><Link to="/student">마이페이지</Link></li> */}